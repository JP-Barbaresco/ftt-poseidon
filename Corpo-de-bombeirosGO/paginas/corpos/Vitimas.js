...
import { formVitimas, clearFormVitimas } from "../../actions/index";
...
export default function Vitimas({ navigation }) {
  ...
  async function buscaDeCorpos() {
    ...
    store.dispatch(clearFormVitimas);
    let form = {
      nome_vitima: nome,
      idade_vitima: idade,
      sexo_vitima: sexo,
    ...
    store.dispatch(formVitimas(form));
  }
              ...
              <View>
                <View>
                  <TouchableHighlight
                    ...
                    onPress={() =>
                      navigation.navigate("Localizacao", buscaDeCorpos())
                    }
