...
import { formEquipe, clearFormEquipe } from "../../actions/index";
...
export default function Equipe({ navigation }) {
  ...
  async function buscaDeCorpos() {
    ...
    //   }),
    // });
    store.dispatch(clearFormEquipe);
    let form = {
      RAI: rai,
      dia_semana: dia,
      apoio: apoio,
    ...
    store.dispatch(formEquipe(form));
  }
              ...
              <View>
                <View>
                  <TouchableHighlight
                    ...
                    onPress={() =>
                      navigation.navigate("Vitimas", buscaDeCorpos())
                    }
